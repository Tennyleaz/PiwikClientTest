...
namespace WPSX.Tracker
{
    ...
    public class WPSXTracker
    {
        ...
        /*public delegate void SendRecordEventHandler(SendRecordCompleteEventArgs e);
        /// <summary>
        /// 當傳送完成或失敗會發生
        /// </summary>
        ...
        public WPSXTracker(string serverURL, string version, string userID,
            string appLocale = null, int siteID = 1, string appName = "WPSX", int? customWidth = null, int? customHeight = null, bool ignoreSSLWarning = false)
        {
            ...
            /*string strDebug = "serverURL=" + serverURL + "\nversion=" + version + "\nuserID=" + userID +
                "\nappLocale=" + appLocale + "\nsiteID=" + "\nappName=" + appName + "\ncustomWidth=" + customWidth + "\ncustomHeight=" + customHeight + "\nignoreSSLWarning=" + ignoreSSLWarning;
            Logger.WriteLog(LOG_LEVEL.LL_NORMAL_LOG, strDebug);*/
        }        
        ...
        public TrackerResult SendScanRecord(string sourceLanguage)
        {
        ...
        /// <param name="destinationLanguage">翻譯目標語言</param>
        /// <returns>true=開始傳送 false=忙碌中</returns>
        public TrackerResult SendTranslateRecord(string engineType, string sourceLanguage, string destinationLanguage)
        {
            TrackerResult result = new TrackerResult();
            if (_excptionType != TrackerExcptionType.ArgumentExcption)
            {
