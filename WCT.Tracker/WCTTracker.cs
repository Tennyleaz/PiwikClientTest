...
namespace WCT.Tracker
{
    ...
    public class WCTTracker
    {
        ...
        public WCTTracker(string serverURL, string version, string userID,
            string appLocale = null, int siteID = 5, string appName = "WCT", int? customWidth = null, int? customHeight = null, bool ignoreSSLWarning = false)
        {
        ...
        public TrackerResult SendOperation(WCT_OP recordType)
        {
        ...
        public TrackerResult SendOperation(WCT_Import_OP recordType)
        {
            TrackerResult result = new TrackerResult();
            if (_excptionType != TrackerExcptionType.ArgumentExcption)
            {
        ...
        public TrackerResult SendOperation(WCT_Export_OP recordType)
        {
            TrackerResult result = new TrackerResult();
            if (_excptionType != TrackerExcptionType.ArgumentExcption)
            {
        ...
        public TrackerResult SendOperation(WCT_SYNC_OP recordType)
        {
            TrackerResult result = new TrackerResult();
            if (_excptionType != TrackerExcptionType.ArgumentExcption)
            {
