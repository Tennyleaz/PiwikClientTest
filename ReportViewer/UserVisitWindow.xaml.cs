...
namespace ReportViewer
{
    ...
    public partial class UserVisitWindow : Window
    {
                ...
                case ReportDuration.week:
                    {
                        ...
                        lbConditions.Content = "專案 " + _projectID + " " + displayDate + viewPeriod;                        
                        break;
                    }
        ...
        private void Worker_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            ...
            lbConditions.Content += "，共 " + DisplayUserCollection.Count + " 位使用者的紀錄";
        }
        ...
        private void Worker_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            if (GetVisitorIDs(out userList) == HttpStatusCode.OK)
            {
                ...
                {
                    VisitorProfie profile = null;
                    if (GetVisitorProfile(user.idvisitor, out profile) == HttpStatusCode.OK)
                    {
                        if (profile == null)
                        {
        ...
        private HttpStatusCode GetVisitorIDs(out List<MatomoUser> users)
        {
            ...
            if (_duration == ReportDuration.range)
            {
                url = PiwikServerUrl
                    ...
                    //+ "&segment=" + HttpUtility.UrlEncode("visitEndServerDate>" + firstDayOfWeekString)
                    + "&token_auth=" + Token
